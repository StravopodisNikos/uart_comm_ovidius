...
// LOGGER (Data logging MCU) - MEGA board
#define DEBUG_LOGGER        Serial
#define SerialLOGGER2Master Serial1 
#define SerialLOGGER2ASA    Serial2
#define SerialLOGGER2IDDH   Serial3 // IDDH HANDLES DATA TRANSFER BETWEEN MINOR PERIPHERALS
